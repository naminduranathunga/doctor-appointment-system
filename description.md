...
Problem: In Sri Lanka, people have to travel very early to get a section's appoinment number, and sometimes have to wait in lines for hours. Even after that some people have to go back without getting a number to appoinment. 

Solution: A SaaS type section appointment system targetting small dispenceries and medical centers. (Dentals in this case.) 
...
- medical center can add multiple sections.
...
- Select the section, select the date, select the time, and a number will be allocated, estimated time to presence is given.
